...
export function changeWordSpacing(spacingSize, unit = "em") {
...
export function changeLetterSpacing(spacingSize, unit = "em") {
...
export function removeCustomStyles() {
...
export function applyCompact(settings) {
    // changeLetterSpacing();
...
export function applyOpen(settings) {
...
export function applyRelaxed(settings) {
...
export function importGoogleFont(fontName) {
